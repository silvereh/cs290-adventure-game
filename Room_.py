...
class Armory(Room):
    def __init__(self):
        ...
        self.findKey = "- the key fell *Down* the table."
...
class Catacombs(Room):
    def __init__(self):
        ...
        self.lookAfterFight = "\to the *East* is the catacomb entrance and to the *Wes* lay another room which you have not yet entered.\n"
...
class TrappedRoom(Room):
    def __init__(self):
        ...
        self.text = "\nYou open the door to find a hall.\nPaintings litter the walls.\nAt the other end of the hallway, to the *South*, you see a doorway.\n"
